...
class Image2ImageTest(BaseTest):
    ...
    def test_create_product_photos(self):
        self.common_step_for_I2I(ElementLocators.WORK_SECTION_BUTTON_XPATH, ElementLocators.CREATE_PRODUCT_UNDER_WORK_SECTION_XPATH, ElementLocators.TEST_PRODUCT_IMAGE, ElementLocators.STYLE_CHOICE_BUTTON_XPATH)
